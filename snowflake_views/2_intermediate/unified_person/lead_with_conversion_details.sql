...
FROM CLIENT_DB.BASE_DEV.SALESFORCE_LEAD_ALL AS LEAD
LEFT JOIN CLIENT_DB.BASE_DEV.SALESFORCE_OPPORTUNITY AS OPP
    ON LEAD.CONVERTED_OPPORTUNITY_ID = OPP.ID
LEFT JOIN CLIENT_DB.STATIC_FILES.COUNTRY_MAPPING AS CMAP
