"""Tests for the push activity generator module."""

from src.generators.push_activity import generate
...
def test_push_activity_unique_ids() -> None:
    """Test that generated push activity IDs are unique."""
...
def test_push_activity_with_related_objects() -> None:
    """Test push activity generation with related objects."""
    ...
    # Generate push activities with related data
    df = generate(
        SMALL_SAMPLE_SIZE,
